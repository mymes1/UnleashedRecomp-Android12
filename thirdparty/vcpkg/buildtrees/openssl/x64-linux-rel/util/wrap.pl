...
BEGIN {
    ...
    require '/home/runner/workspace/thirdparty/vcpkg/buildtrees/openssl/src/nssl-3.4.0-821e8e5bdc.clean/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/runner/workspace/thirdparty/vcpkg/buildtrees/openssl/src/nssl-3.4.0-821e8e5bdc.clean/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/runner/workspace/thirdparty/vcpkg/buildtrees/openssl/src/nssl-3.4.0-821e8e5bdc.clean/test/default-and-jitter.cnf';
    shift;
