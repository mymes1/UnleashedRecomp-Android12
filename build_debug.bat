...
"E:\VSInstall\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake.exe" . --preset x64-Clang-RelWithDebInfo
if errorlevel 1 exit /b 1
"E:\VSInstall\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake.exe" --build "E:\UnleashedRecompAndroid\out\build\x64-Clang-RelWithDebInfo" --target UnleashedRecomp
