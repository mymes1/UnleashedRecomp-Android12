...
PPC_FUNC(sub_82467890)
{
    ...
    // EXPERIMENTAL: best-effort first-person / head camera support.
    // Off by default; see patches/first_person_patches.cpp for what this does
    // and does not know for certain about the camera's memory layout.
    FirstPersonCameraFrameUpdate(ctx.r3.u32);
}
