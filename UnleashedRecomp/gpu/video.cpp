...
// Declared unconditionally: OnAndroidResume() (below) is defined for every platform even
// though it's only ever called from the Android-gated tick path in app.cpp.
[[maybe_unused]] static uint64_t g_androidSwapchainRetryAfterMs;
