...
"E:\VSInstall\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake.exe" --build out/build/x64-Clang-HostTools --target XenonRecomp XenosRecomp file_to_c x_decompress
